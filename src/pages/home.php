...
<body class="flex min-h-screen flex-col bg-accent">
  ...
  <?php
  $title = "Welcome to";
  $highlight = '<span class="text-primary">Promise</span>';
  ...
  <section class="flex-grow py-16 md:py-20">
    <div class="relative z-10 m-auto max-w-screen-xl justify-center py-2">
      ...
      <div class="mx-auto max-w-5xl">
        ...
        <p
          class="font-Unna-regular mx-auto mt-6 mb-24 max-w-3xl text-center text-base leading-7 text-pink-800 sm:text-lg md:text-xl">
  ...
  <div class="m-6 flex justify-center sm:m-8">
    <a href="../pages/products.php"
      class="inline-block rounded-full bg-gradient-to-r from-candy-peach to-candy-pink px-8 py-4 text-base font-semibold text-white shadow-[0_0_30px_rgba(249,192,175,0.35)] transition-all hover:from-candy-peach-dark hover:to-candy-pink-dark hover:shadow-[0_0_40px_rgba(249,192,175,0.5)] focus:ring-2 focus:ring-candy-peach focus:ring-offset-2 focus:ring-offset-candy-cream focus:outline-none sm:px-10 sm:py-5 sm:text-lg">Shop
      Now</a>
  </div>
