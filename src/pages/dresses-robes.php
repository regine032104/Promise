...
// Include database connection and get dress products
...
<head>
  ...
  <title>Dresses & Robes - Promise</title>
    ...
    <div class="w-full">
        ...
        <nav class="mb-6">
          <ol class="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li class="text-gray-400">/</li>
            <li class="text-gray-900 font-medium">Dresses & Robes</li>
          </ol>
        </nav>

        <!-- Page Title -->
        <h1 class="font-Tinos text-4xl text-pink-950 mb-4">Dresses & Robes</h1>
        
        <!-- Results and Sort -->
        <div class="flex items-center justify-between mb-8">
          <p class="text-gray-600">Showing 1-<?=min(9, $total_dresses)?> of <?=$total_dresses?> results</p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <?php if (empty($dress_products)): ?>
            <div class="col-span-full text-center py-12">
              <h3 class="font-Tinos text-2xl text-pink-800 mb-4">No dresses found</h3>
