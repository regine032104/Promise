    ...
    <div class="relative z-10 m-auto max-w-screen-xl justify-center px-4 pb-4">
      ...
      <div class="mb-16">
        <div class="bg-white rounded-lg shadow-[0_8px_30px_rgba(210,199,229,0.12)] p-8">
          <h3 class="font-Tinos text-2xl text-pink-950 mb-6 text-center">How to Measure Yourself</h3>
          <p class="text-center text-gray-600 mb-8">Dresses are measured and put into their closest size category. Please allow for a couple centimeters discrepancy. If a dress has a lace-up back, size can be adjustable, please message to check fit before purchasing.</p>
          
          <!-- Measurement Images -->
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            <div class="text-center">
              <img src="../img/size1.jpg" alt="How to measure yourself - visual guide" class="w-full max-w-md mx-auto rounded-lg shadow-lg">
              <p class="text-sm text-gray-600 mt-2">Measurement Guide</p>
            </div>
            <div class="text-center">
              <img src="../img/size2.jpg" alt="Size chart visual guide" class="w-full max-w-md mx-auto rounded-lg shadow-lg">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="space-y-6">
              ...
              <div class="border-l-4 border-candy-peach pl-4">
                ...
                <p class="text-gray-700 text-sm">
                  <strong>Step 1:</strong> Find the smallest part of your waist (bend sideways - where it creases is your waist)
      ...
      <div class="mb-16">
        <div class="bg-white rounded-lg shadow-[0_8px_30px_rgba(210,199,229,0.12)] p-8">
          <h3 class="font-Tinos text-2xl text-pink-950 mb-6 text-center">Our Universal Size Chart</h3>
          <p class="text-center text-gray-600 mb-8">Below is our universal size chart and you will find instructions on how to measure yourself.</p>
            ...
            <table class="w-full border-collapse">
              <thead>
                <tr class="bg-candy-cream">
                  ...
                  <th class="border border-candy-lavender-light px-4 py-3 text-center text-pink-950 font-semibold">Bust (cm)</th>
                  <th class="border border-candy-lavender-light px-4 py-3 text-center text-pink-950 font-semibold">Waist (cm)</th>
                  <th class="border border-candy-lavender-light px-4 py-3 text-center text-pink-950 font-semibold">Hips (cm)</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
            <div class="space-y-4">
              <p class="text-gray-700">
                Please know that most brides of average height do not need to worry about the length of the gown being too short. Most brides will need their gown hemmed to the perfect length by their bridal seamstress, which is absolutely normal.
              </p>
              <p class="text-gray-700">
                When comparing your height to the length of each gown, please compare your hollow to hem measurement to the hollow to hem measurement of each gown. This measurement is "not" your actual height.
              </p>
              <p class="text-gray-700">
                The hollow to hem measurement is the measurement from the base of your neck (where your neck dips in) to the hem of where you would the hem to end. Try to get someone to help as you will need to stand up straight without looking down when taking this measurement.
              </p>
              <p class="text-gray-700 font-semibold">
                It is always a good idea to have the same or similar shoe height on that you plan to wear the day of the wedding.
              </p>
            </div>
            
            <div class="text-center">
              <img src="../img/tips.jpg" alt="Alteration tips and height requirements" class="w-full max-w-md mx-auto rounded-lg shadow-lg">
      ...
      <div class="mb-16">
        <div class="bg-white rounded-lg shadow-[0_8px_30px_rgba(210,199,229,0.12)] p-8">
          <h3 class="font-Tinos text-2xl text-pink-950 mb-6 text-center">Alteration Tips</h3>
          
          <div class="space-y-6">
            <p class="text-gray-700">
              Most bridal gowns can be altered at least 1-2 sizes smaller, however, some bridal gowns usually can not be let out (made larger), since the interior seams are notched for the best couture fit. If your not sure please contact us about the specific dress and we can check it for you and discuss the possibilities.
            </p>
            <p class="text-gray-700">
              We also suggest consulting a local professional, experienced bridal seamstress so he/she can give you their opinion on whether they personally would be able to do the alterations. Our past brides have had positive success with taking the listed pictures to their local bridal seamstress to see if it is possible.
            </p>
          </div>
        </div>
      </div>
      ...
      <!-- Call to Action -->
      <div class="text-center">
        <h2 class="font-Tinos text-3xl text-pink-950 mb-4">Need Help Finding Your Size?</h2>
        <p class="text-pink-800 mb-8 max-w-2xl mx-auto">
          Our experienced bridal consultants are here to help you find the perfect fit. Schedule a consultation or contact us for personalized sizing assistance.
        </p>
        <div class="flex flex-col sm:flex-row gap-4 justify-center">
          <a href="../pages/reservation.php"
            class="inline-block rounded-full bg-gradient-to-r from-candy-peach to-candy-pink px-8 py-4 text-base font-bold text-black shadow-[0_0_30px_rgba(249,192,175,0.35)] transition-all hover:from-candy-peach-dark hover:to-candy-pink-dark hover:shadow-[0_0_40px_rgba(249,192,175,0.5)] focus:ring-2 focus:ring-candy-peach focus:ring-offset-2 focus:ring-offset-candy-cream focus:outline-none">
            Schedule Consultation
          </a>
          <a href="../pages/about.php"
            class="inline-block rounded-full border-3 border-candy-peach px-8 py-4 text-base font-semibold text-candy-peach transition-all hover:bg-candy-peach hover:text-white focus:ring-2 focus:ring-candy-peach focus:ring-offset-2 focus:ring-offset-candy-cream focus:outline-none">
            Contact Us
          </a>
        </div>
      </div>
