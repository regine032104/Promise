...
<body class="flex min-h-screen flex-col bg-pink-100">
  ...
  <main class="mx-auto max-w-screen-xl flex-1 py-10">
    <div class="flex flex-col gap-8">
      ...
      <div class="w-full">
        <div id="product-filters" class="mb-6 rounded-lg bg-pink-50 p-4 shadow-sm">
          <div class="mx-auto max-w-screen-xl px-2">
            <div class="flex items-center justify-between gap-4">
              <div class="flex items-center gap-3 text-pink-700">
                <button id="toggle-filters"
                  class="inline-flex cursor-pointer items-center gap-2 rounded-md px-2 py-1 text-sm text-pink-700 hover:bg-pink-100">
                ...
                <div class="text-sm text-pink-600">111 Results</div>
              </div>
              <div class="text-sm text-pink-700">
                Sort:
                <select id="sort-select"
                  class="ml-2 cursor-pointer rounded border border-pink-100 bg-pink-50 px-2 py-1 text-pink-700">
            ...
            <div id="filter-controls" class="mt-4 flex w-full flex-wrap items-center gap-3">
              <button class="filter-btn rounded border border-pink-200 bg-white px-4 py-2 text-sm text-pink-700">
      ...
      <div class="mx-auto max-w-screen-xl">
        <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <article
            ...
            data-size="XS, S, M, L"
            data-silhouette="Ball Gown"
            data-length="Floor"
            data-sleeves="Long Sleeves"
            data-collection="Online Collection">
            <div class="relative h-56 overflow-hidden sm:h-64 md:h-72 lg:h-80">
              ...
              <button class="absolute top-3 right-3 rounded-full bg-white/80 p-2 text-pink-600 shadow">
                ♡
              </button>
            </div>
            <div class="flex flex-1 flex-col justify-between p-4">
              <div>
                <h3 class="font-semibold text-pink-700">
                  “Isabella” Classic Lace Princess Dress
                </h3>
                <p class="mt-1 text-pink-600">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$200.00</div>
                <button
          ...
          <article
            ...
            data-availability="In Stock"
            data-size="S, M, L, XL"
            data-silhouette="A-Line"
            data-length="Floor"
            data-sleeves="Spaghetti Straps, Off the Shoulder"
            data-collection="Online Collection">
            <div class="relative h-56 overflow-hidden sm:h-64 md:h-72 lg:h-80">
            ...
            <div class="flex flex-1 flex-col justify-between p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$100.00</div>
                <button
                  class="cursor-pointer rounded-md bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-white transition hover:shadow-[0_0_30px_rgba(236,72,153,0.25)]">
                  Add to Cart
                </button>
          ...
          <article
            ...
            data-silhouette="Ball Gown"
            data-length="Floor"
            data-sleeves="Spaghetti Straps"
            data-collection="Retailer Collection">
            <div class="relative h-56 overflow-hidden sm:h-64 md:h-72 lg:h-80">
            ...
            <div class="flex flex-1 flex-col justify-between p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$400.00</div>
                <button
                  class="cursor-pointer rounded-md bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-white transition hover:shadow-[0_0_30px_rgba(236,72,153,0.25)]">
                  Add to Cart
                </button>
          ...
          <article
            ...
            <div class="flex flex-1 flex-col justify-between p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$350.00</div>
                <button
                  class="cursor-pointer rounded-md bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-white transition hover:shadow-[0_0_30px_rgba(236,72,153,0.25)]">
                  Add to Cart
                </button>
          ...
          <article
            ...
            <div class="flex flex-1 flex-col justify-between p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$180.00</div>
                <button
                  class="cursor-pointer rounded-md bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-white transition hover:shadow-[0_0_30px_rgba(236,72,153,0.25)]">
                  Add to Cart
                </button>
          ...
          <article
            ...
            <div class="flex flex-1 flex-col justify-between p-4">
              ...
              <div class="mt-4 flex items-center justify-between">
                <div class="font-bold text-pink-700">$450.00</div>
                <button
                  class="cursor-pointer rounded-md bg-gradient-to-r from-pink-500 to-rose-500 px-4 py-2 text-white transition hover:shadow-[0_0_30px_rgba(236,72,153,0.25)]">
                  Add to Cart
                </button>
