...
<body class="flex min-h-screen flex-col bg-pink-100">
          ...
          <div id="reviews-row" tabindex="0"
            ...
            <figure class="min-w-[220px] snap-center sm:min-w-[260px] md:min-w-[320px] md:snap-start lg:min-w-[360px]"
              ...
              <div class="aspect-[3/4] overflow-hidden rounded-lg bg-white">
                <img src="../images/p-1.webp" alt="Gwynne M." loading="lazy" decoding="async"
            ...
            <figure class="min-w-[220px] snap-center sm:min-w-[260px] md:min-w-[320px] md:snap-start lg:min-w-[360px]">
              <div class="aspect-[3/4] overflow-hidden rounded-lg bg-white">
                <img src="../images/p-5.webp" alt="Brianna F.K." loading="lazy" decoding="async"
                  sizes="(min-width: 1024px) 360px, (min-width: 768px) 320px, (min-width: 640px) 260px, 220px"
                  class="h-full w-full object-cover" />
              </div>
              <figcaption class="mt-4 text-center">
            ...
            <figure class="min-w-[220px] snap-center sm:min-w-[260px] md:min-w-[320px] md:snap-start lg:min-w-[360px]">
              <div class="aspect-[3/4] overflow-hidden rounded-lg bg-white">
                <img src="../images/p-3.webp" alt="Brittany F." loading="lazy" decoding="async"
                  sizes="(min-width: 1024px) 360px, (min-width: 768px) 320px, (min-width: 640px) 260px, 220px"
                  class="h-full w-full object-cover" />
              </div>
              <figcaption class="mt-4 text-center">
            ...
            <figure class="min-w-[220px] snap-center sm:min-w-[260px] md:min-w-[320px] md:snap-start lg:min-w-[360px]">
              <div class="aspect-[3/4] overflow-hidden rounded-lg bg-white">
                <img src="../images/p-4.webp" alt="Camille R." loading="lazy" decoding="async"
                  sizes="(min-width: 1024px) 360px, (min-width: 768px) 320px, (min-width: 640px) 260px, 220px"
                  class="h-full w-full object-cover" />
              </div>
              <figcaption class="mt-4 text-center">
            ...
            <figure class="min-w-[220px] snap-center sm:min-w-[260px] md:min-w-[320px] md:snap-start lg:min-w-[360px]">
              <div class="aspect-[3/4] overflow-hidden rounded-lg bg-white">
                <img src="../images/p-2.jpg" alt="Samantha P." loading="lazy" decoding="async"
                  sizes="(min-width: 1024px) 360px, (min-width: 768px) 320px, (min-width: 640px) 260px, 220px"
                  class="h-full w-full object-cover" />
              </div>
              <figcaption class="mt-4 text-center">
  ...
  <section class="py-16 md:py-20">
    <div class="mx-auto max-w-screen-xl px-4">
      <div class="rounded-xl bg-[#a8c4d6] p-6 sm:p-10 md:p-12">
          ...
          <div class="relative">
            <div class="overflow-hidden rounded-lg shadow-[0_10px_30px_rgba(2,6,23,0.15)]">
              <div class="aspect-[3/4] md:aspect-[3/4]">
                <img src="../images/about-image.webp" alt="Brides trying on dresses at a trunk show" loading="lazy"
  ...
  <div class="m-6 flex justify-center sm:m-8">
    <a href="../pages/products.php"
      class="inline-block rounded-full bg-gradient-to-r from-pink-500 to-rose-500 px-6 py-3 text-sm font-semibold text-white shadow-[0_0_30px_rgba(236,72,153,0.35)] transition-all hover:from-pink-600 hover:to-rose-600 hover:shadow-[0_0_40px_rgba(236,72,153,0.5)] focus:ring-2 focus:ring-pink-400 focus:ring-offset-2 focus:ring-offset-pink-100 focus:outline-none sm:px-8 sm:py-4 sm:text-base">Shop
      Now</a>
  </div>
