...
<div id="product-modal"
  ...
  <div class="flex items-start justify-between gap-4 border-b border-pink-300 px-5 py-4">
    ...
    <button id="close-product" aria-label="Close product modal"
      class="cursor-pointer rounded-md px-2 py-1 text-3xl font-semibold leading-none text-pink-600/80 transition hover:rotate-90 hover:text-pink-800">×</button>
  </div>

  <!-- body -->
  <div class="grid grid-cols-1 gap-4 p-5 md:grid-cols-2">
    <div class="overflow-hidden rounded-lg bg-pink-50">
      <img id="pm-image" src="" alt="Product image" class="h-full w-full object-cover" />
    </div>
